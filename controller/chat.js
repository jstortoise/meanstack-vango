...
exports.getYearList = function(req, res) {
    Car.distinct("year", function(err, car) {
        res.json(car);
    });
}
...
exports.getCarList = function(req, res) {
    ...
    Car.distinct("carmake", { year: year }, function(err, car) {
        res.json(car);
    });
}
...
exports.d15 = function(req, res) {
    ...
    if (chatuserArray[email] == null) {
        ...
        chatuserArray[email].setStage(15);
        res.render('chat/15');
    }
}
exports.d16 = function(req, res) {
    ...
    if (chatuserArray[email] == null) {
        ...
        chatuserArray[email].setStage(16);
        res.render('chat/16');
    }
}
exports.d17 = function(req, res) {
    var email = req.user.local.email;
    if (chatuserArray[email] == null) {
        res.render('chat/1');
    } else {
        chatuserArray[email].setStage(17);
        res.render('chat/17');
    }
}
